                    ...
                    <div class="wrapper2">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-2-grid">
                                <div class="row">
                                    <?php
                                    query_posts(array('post_type' => 'doctor-profile', 'category_name' => 'skin-cancer-question', 'posts_per_page' => '6', 'orderby' => 'date', 'order' => 'DESC'));
                                    $q = 1;
                                    if (have_posts()) {
                                        while (have_posts()) {
                                            the_post();
        ...
        <div class="row row-block2 bg-2 treatment-option">
            <div class="wrapper">
                ...
                <div id="tabs" class="bg-1">
                    <ul>  <?php
                        query_posts(array('post_type' => 'doctor-profile', 'category_name' => 'skin-treatment-options', 'posts_per_page' => '3', 'orderby' => 'date', 'order' => 'DESC'));
                        $k = 1;
                        if (have_posts()) {
                            while (have_posts()) {
                                the_post();
            ...
            <?php if (get_field("research_grants_title")): ?>
                <div class="wrapper">
                    <div class="col-md-10 column-centered">
                        ...
                        <!--end row-->   
                        <?php
                        query_posts(array('post_type' => 'doctor-profile', 'category_name' => 'skin-doctor', 'posts_per_page' => '4', 'orderby' => 'date', 'order' => 'DESC'));
                        $i = 2;
                        if (have_posts()) {
                            while (have_posts()) {
                                the_post();
