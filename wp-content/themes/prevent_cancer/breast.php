...
<div id="main" class="site-main">
    <div class="lung bg-2">
                    ...
                    <div class="wrapper2">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-2-grid">
                                <div class="row">
                                    <?php
                                    query_posts(array('post_type' => 'doctor-profile', 'category_name' => 'breast-cancer-question', 'posts_per_page' => '6', 'orderby' => 'date', 'order' => 'DESC'));
                                    $q = 1;
                                    if (have_posts()) {
                                        while (have_posts()) {
                                            the_post();
        ...
        <div class="row row-block2 bg-2 treatment-option">
            <?php if (get_field("treatment_options_title")): ?>
                <div class="wrapper">
                    ...
                    <div id="tabs" class="bg-1">
                        <ul> 
                            <?php
                            query_posts(array('post_type' => 'doctor-profile', 'category_name' => 'breast-treatment-options', 'posts_per_page' => '3', 'orderby' => 'date', 'order' => 'DESC'));
                            $k = 1;
                            if (have_posts()) {
                                while (have_posts()) {
                                    the_post();
            ...
            <?php if (get_field("research_grants_title")): ?>
                <div class="wrapper">
                    <div class="col-md-10 column-centered">
                        ...
                        <?php
                        query_posts(array('post_type' => 'doctor-profile', 'category_name' => 'breast-doctor', 'posts_per_page' => '4', 'orderby' => 'date', 'order' => 'DESC'));
                        $i = 2;
                        if (have_posts()) {
                            while (have_posts()) {
                                the_post();
                ...
                <div class="wrapper">
                    <div class="col-md-10 column-centered align-center">
                        ...
                        <div class="row psa-materials">
                            ...
                            <div class="col-md-5 col-sm-5">
                                <div class="col-md-8 col-sm-10 column-centered">
                                    ...
                                    <h6> Breast Health Education Guide <br><a target="_blank" href="http://preventcancer.org/?p=17051" target="_blank">Learn More</a></h6>				        	
                                </div>
                            </div>
                        </div>
                        <div class="row row-block psa-materials">
                            ...
                            <div class="col-md-3 col-sm-5">
                                <span class="video-icon"><img src="<?php echo bloginfo('template_directory') ?>/images/play-video.png"></span>
                                <h6><?php the_field('psa_video_title'); ?><br><a href="<?php the_field('psa_video_link'); ?>" target="_blank">View the Ad</a></h6>
                            </div>
                        </div>            
                    </div>
                </div>         
